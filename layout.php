...
try {
    ...
    $sql = $conn->prepare("SELECT * FROM users WHERE user_name = :user_name LIMIT 1");
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <!--<input type="text" name="" class="form-control" id="" value="http://abc.com">-->
                    <!--<div class="btn-box">-->
              ...
              <div class="row">
                <div class="col-md-7 col-lg-6 ">
                  <div class="detail-box">
                    ...
                    <!--<input type="text" class="form-control" name="" id="" value="http://abc.com">-->
                    <!--<div class="btn-box">-->
                    <!--  <a href="javascript:void(0)" class="btn1">-->
                    <!--    Order Now-->
                    <!--  </a>-->
        ...
        <div class="col-md-6">
          <div class="form_container">
            <form action="">
              ...
              <div class="btn_box">
                <a href="<?php echo $url;?>" target="_blank" class="btn btn-warning text-light">
                  Buy Now
                </a>
              </div>
            </form>
